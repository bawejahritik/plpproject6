...
public interface IToken {
    /**
     * Represents the location in the source code.  Lines and columns begin
     counting at 1.
     */
    ...
    public Kind getKind();
    /**
     * Returns a char array containing the characters from the source program
     that represent this IToken.
     *
     * Note that if the the IToken kind is a STRING_LIT, the characters are the
     raw characters from the source, including the delimiters and unprocessed
     * escape sequences.
     *
     * @return
     */
    ...
    returned String does not include the delimiters, and escape sequences have been
    handled.
     */
